...
- [openconfig_ethernet.proto](#openconfig_ethernet-proto)
    - [EthernetConfig](#opi_api-network-v1alpha1-EthernetConfig)
    - [EthernetCounters](#opi_api-network-v1alpha1-EthernetCounters)
    - [EthernetIf](#opi_api-network-v1alpha1-EthernetIf)
    - [EthernetInDistribution](#opi_api-network-v1alpha1-EthernetInDistribution)
    - [EthernetState](#opi_api-network-v1alpha1-EthernetState)
  
    - [EthDuplexMode](#opi_api-network-v1alpha1-EthDuplexMode)
    - [EthFecMode](#opi_api-network-v1alpha1-EthFecMode)
    - [EthPortSpeed](#opi_api-network-v1alpha1-EthPortSpeed)
